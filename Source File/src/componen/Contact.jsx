...
function Contact() {
  return (
    <div className=" flex flex-col items-center  justify-center bg-basecolor p-10  text-center text-basefont lg:flex lg:h-40 lg:max-w-full lg:flex-row lg:items-center lg:justify-between lg:px-28 ">
